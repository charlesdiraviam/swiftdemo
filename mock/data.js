...
window.SWIFT_DATA = {
  ...
  campaigns: {
    default: {
      ...
      headlineHTML: 'Emergency? <span class="text-teal-100">Think SWIFT.</span>',
    ...
    flu: {
      ...
      headlineHTML: 'Flu or fever? <span class="text-teal-100">Walk in today.</span>',
    ...
    sports: {
      ...
      headlineHTML: 'Sports injury? <span class="text-teal-100">Seen fast.</span>',
      subtext: "Emergency Physicians treat sprains, strains and joint injuries on-site with imaging. Trusted by local clubs.",
      primaryCta: { label: "Online check-in", href: "#checkinForm" },
      ...
      stickyCta: { label: "Online check-in", href: "#checkinForm" },
    ...
    infusion: {
      ...
      headlineHTML: 'Iron infusion in <span class="text-teal-100">under an hour.</span>',
    ...
    kids: {
      ...
      headlineHTML: 'Sick child? <span class="text-teal-100">In-house paediatricians.</span>',
    ...
    paeds: { id: "paeds", name: "Kids / Paediatrics", eyebrow: "Ages 3 months +", headlineHTML: 'Sick child? <span class="text-teal-100">In-house paediatricians.</span>', subtext: "Calm, child-friendly care by paediatric-trained Emergency Physicians.", primaryCta: { label: "Book / Walk in", action: "openBooking", service: "Paediatrics" }, secondaryCta: { label: "What we treat", href: "#services" }, highlightService: "Paediatrics", ribbonText: "You're viewing our Paediatric info", stickyCta: { label: "Walk in / Book", action: "openBooking", service: "Paediatrics" }, services: ["Paediatrics", "Fracture Clinic", "Sports Injury", "Infusion Clinic", "Interventional Radiology", "Physiotherapy"], intentsOrder: ["now", "imaging", "infusion"], bookingService: "Paediatrics", hideSections: [] },
  },
